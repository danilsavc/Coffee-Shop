...
function Map() {
    return (
        <GoogleMap zoom={18} center={{lat: 47.8457944565378,  lng: 35.12551625143726}} mapContainerClassName="map-container">
            <MarkerF key="marker_1" position={{lat: 47.8457944565378,  lng: 35.12551625143726}} />
        </GoogleMap>
    )
}
