...
function Map() {
    return (
        <GoogleMap zoom={15} center={{lat: 47.8457944565378,  lng: 35.12551625143726}} mapContainerClassName="map-container">
            <Marker position={{lat: 47.8457944565378,  lng: 35.12551625143726}}/>
        </GoogleMap>
    )
}
